...
def main():
    ...
    bg = PhotoImage(file = 'veterans.png') # to add the background image
    ...
    start_color = PhotoImage(file = 'start.png')
    # load the color used for the end node [red]
    end_color = PhotoImage(file = 'end.png')
    # load the color used for the cover node [green]
    cover_color = PhotoImage(file = 'cover.png')
    # load the color used for the obstacle node [magenta]
    obstacle_color = PhotoImage(file = 'obstacle.png')
    # load the color used for the path node [turquois]
    path_color = PhotoImage(file = 'path3.png')
